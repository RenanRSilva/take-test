...
import {VehicleNavigation} from '../../../src/presentation/components/vehicle-navigation/VehicleNavigation'
...
describe('vehicle search bar component', () => {
  ...
  it('show filter button', () => {
    expect(vehicleNavigation.getByTestId('filter-button')).toBeInTheDocument()
  })
