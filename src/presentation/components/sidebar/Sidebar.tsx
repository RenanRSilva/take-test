...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className={`${styles.sidebar} ${isOpen ? styles.open : styles.closed}`}>
      ...
      <button data-testid="handle-sidebar-button" className={styles.sidebar_button} onClick={handleSideBar}>
       { isOpen ? <img data-testid="close-icon" src={CloseArrowIcon} alt="" /> : <img data-testid="open-icon" src={OpenArrowIcon} alt="" /> }
      </button>
    </aside>
  )
}
